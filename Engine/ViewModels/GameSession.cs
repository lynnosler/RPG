...
namespace Engine.ViewModels
{
     public class GameSession : BaseNotificationClass
     {
          ...
          public bool HasLocationToEast =>
               CurrentWorld.LocationAt(_currentLocation.XCoordinate + 1, CurrentLocation.YCoordinate) != null;
          ...
          public GameSession()
          {
               CurrentPlayer = new Player("Lynn", "Fighter", 0, 10, 10, 1000000);
               ...
               foreach (Quest quest in CurrentLocation.QuestsAvailableHere)
               {
                    ...
                    if (questToComplete != null)
                    {
                         if (CurrentPlayer.HasAllTheseItems(quest.ItemsToComplete))
                         {
                              ...
                              CurrentPlayer.AddExperience(quest.RewardXP);
                              ...
                              {
                                   GameItem rewardItem = ItemFactory.CreateGameItem(iq.ItemID);
